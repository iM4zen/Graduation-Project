...
if ($_SERVER["REQUEST_METHOD"] == 'GET') {
    ...
    $id = $_GET['id'];
    $sql = "select * from nateega2ltolab where id=$id";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "update nateega2ltolab set id2lmada='$id2lmada', aldrga='$aldrga' where id='$id'";
    $result = $conn->query($sql);
    if (!$result) {
...
<div class="container my-4">
  ...
  <input type="text" name="id2lmada" value="<?php echo $id2lmada; ?>" class="form-control"> <br>
  <label> الدرجة الحاصل عليها الطالب </label>
  <input type="text" name="aldrga" value="<?php echo $aldrga; ?>" class="form-control"> <br>
  <button type="submit" class="btn btn-outline-warning" name="submit">Submit</button>
  <a href="dashboard7.php" class="btn btn-dark">Cancel</a>
</form>
</table>
</table>
          </div>
