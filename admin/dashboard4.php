...
<html lang="en">
    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">جدول الفصول والمدرسين</p>
        </div>
		<a class='btn btn-success' href='create4.php'>اضافة</a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <a class='btn btn-success' href='update4.php?id=$row[id]'>Edit</a>
      <a class='btn btn-danger' href='delete4.php?id=$row[id]'>Delete </a> 
