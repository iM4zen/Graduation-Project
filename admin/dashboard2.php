    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">جدول الطلاب</p>
        </div>
<a class='btn btn-success' href='create2.php'>اضافة</a>
  ...
  <thead>
    <tr>
      ...
      <th>المستوي العام للطالب</th>
      <th>النشاط المشترك به</th>
    </tr>
  </thead>
  <tbody>
    <?php 
    include "connection.php";
    $sql= "select * from gadwaal2ltoolab";
    ...
    <tr>
      ...
      <a class='btn btn-success' href='update2.php?id=$row[id]'>Edit</a>
