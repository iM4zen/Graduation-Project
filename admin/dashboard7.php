    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">جدول درجات مواد الطلاب</p>
        </div>
<a class='btn btn-success' href='create7.php'>اضافة</a>
  ...
  <tbody>
    ...
    $sql= "select * from nateega2ltolab";
    ...
    <tr>
      ...
      <a class='btn btn-success' href='update7.php?id=$row[id]'>Edit</a>
      <a class='btn btn-danger' href='delete7.php?id=$row[id]'>Delete </a> 
