...
<html lang="en">
    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">جدول المواد الدراسية</p>
        </div>
		<a class='btn btn-success' href='create6.php'>اضافة</a>
  ...
  <thead>
    <tr>
      ...
      <th>الدرجة الصغري للمادة</th>
      <th>الدرجة الكبري للمادة</th>
      <th>مدرس اول مادة</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>$row[madaname]</td>
      <td>$row[also8ra]</td>
      <td>$row[aldrga2lkobra]</td>
      <td>$row[modaresawal]</td>
      <td>
      
      <a class='btn btn-success' href='update6.php?id=$row[id]'>Edit</a>
      <a class='btn btn-danger' href='delete6.php?id=$row[id]'>Delete </a> 
