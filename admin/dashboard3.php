...
<html lang="en">
    ...
    <div class="grid-container">
      ...
      <main class="main-container">
        <div class="main-title">
          <p class="font-weight-bold">جدول الفصول</p>
        </div>
		<a class='btn btn-success' href='create3.php'>اضافة</a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <a class='btn btn-success' href='update3.php?id=$row[id]'>Edit</a>
